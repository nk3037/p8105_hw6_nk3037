...
# Regression model
model = lm (bwt ~ fincome + mrace + frace, data = birthweight)
summary(model)
...
The simple linear model examines the effect that family income and parents' race (mother and father race) have on birth weight.